...
SECRET_KEY = 'django-insecure-18x1%m%1nw!og+s=p8g(6%weh6xff4$h&x8rrp_e6(xa=&nue$'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR,'templates'),
                 os.path.join(BASE_DIR,'frontmachine/build')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
DATABASES = {
    'default': {
        'ENGINE': 'djongo',
        'NAME': 'mydatabase',                    # MongoDB veritabanı adı
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'frontmachine/build/static')
]
